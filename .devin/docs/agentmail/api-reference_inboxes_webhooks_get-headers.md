...
GET https://api.agentmail.to/v0/inboxes/{inbox_id}/webhooks/{webhook_id}/headers
...
Reference: https://docs.agentmail.to/api-reference/inboxes/webhooks/get-headers
...
HttpResponse<String> response = Unirest.get("https://api.agentmail.to/v0/inboxes/inbox_id/webhooks/webhook_id/headers")
...
$response = $client->request('GET', 'https://api.agentmail.to/v0/inboxes/inbox_id/webhooks/webhook_id/headers', [
  'headers' => [
