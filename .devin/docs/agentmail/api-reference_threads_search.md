...
GET https://api.agentmail.to/v0/threads/search
...
Reference: https://docs.agentmail.to/api-reference/threads/search
...
func main() {
	...
	url := "https://api.agentmail.to/v0/threads/search?q=q"
...
url = URI("https://api.agentmail.to/v0/threads/search?q=q")
...
HttpResponse<String> response = Unirest.get("https://api.agentmail.to/v0/threads/search?q=q")
...
$response = $client->request('GET', 'https://api.agentmail.to/v0/threads/search?q=q', [
  'headers' => [
...
var client = new RestClient("https://api.agentmail.to/v0/threads/search?q=q");
...
let request = NSMutableURLRequest(url: NSURL(string: "https://api.agentmail.to/v0/threads/search?q=q")! as URL,
