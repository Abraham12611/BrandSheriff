...
GET https://api.agentmail.to/v0/metrics/events
...
Reference: https://docs.agentmail.to/api-reference/metrics/query-events
...
func main() {
	...
	url := "https://api.agentmail.to/v0/metrics/events"
...
url = URI("https://api.agentmail.to/v0/metrics/events")
...
HttpResponse<String> response = Unirest.get("https://api.agentmail.to/v0/metrics/events")
...
$response = $client->request('GET', 'https://api.agentmail.to/v0/metrics/events', [
  'headers' => [
...
var client = new RestClient("https://api.agentmail.to/v0/metrics/events");
...
let request = NSMutableURLRequest(url: NSURL(string: "https://api.agentmail.to/v0/metrics/events")! as URL,
