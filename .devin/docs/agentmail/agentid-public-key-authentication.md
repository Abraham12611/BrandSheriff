...
> Generate and store a P-256 key, register its public JWK, and submit a strict signed AgentID approval.
...
#### Browser enrollment migration

For organizations using US production, [AgentID browser enrollment](/agentid-browser-enrollment) is the current path for persistent
browser approval. It is not available in EU production. This public-key flow
remains supported during migration; no deprecation date has been announced.
