...
POST https://api.agentmail.to/v0/pods/{pod_id}/webhooks
...
Reference: https://docs.agentmail.to/api-reference/pods/webhooks/create
...
HttpResponse<String> response = Unirest.post("https://api.agentmail.to/v0/pods/pod_id/webhooks")
...
$response = $client->request('POST', 'https://api.agentmail.to/v0/pods/pod_id/webhooks', [
  'body' => '{
  "event_types": [
    "message.received",
    "message.received"
