...
GET https://api.agentmail.to/v0/inboxes/{inbox_id}/webhooks
...
Reference: https://docs.agentmail.to/api-reference/inboxes/webhooks/list
...
HttpResponse<String> response = Unirest.get("https://api.agentmail.to/v0/inboxes/inbox_id/webhooks")
...
$response = $client->request('GET', 'https://api.agentmail.to/v0/inboxes/inbox_id/webhooks', [
  'headers' => [
