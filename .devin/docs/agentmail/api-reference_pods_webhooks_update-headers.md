...
PATCH https://api.agentmail.to/v0/pods/{pod_id}/webhooks/{webhook_id}/headers
...
Reference: https://docs.agentmail.to/api-reference/pods/webhooks/update-headers
...
HttpResponse<String> response = Unirest.patch("https://api.agentmail.to/v0/pods/pod_id/webhooks/webhook_id/headers")
...
$response = $client->request('PATCH', 'https://api.agentmail.to/v0/pods/pod_id/webhooks/webhook_id/headers', [
  'body' => '{}',
  'headers' => [
