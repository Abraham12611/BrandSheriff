...
> Verify the AgentID browser origin, create an enrollment with ordinary authenticated HTTP, and manage browser credentials and consent.
...
The [AgentID configuration document](https://api.agentmail.to/v0/.well-known/agentid-configuration)
