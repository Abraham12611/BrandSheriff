...
DELETE https://api.agentmail.to/v0/inboxes/{inbox_id}/webhooks/{webhook_id}
...
Reference: https://docs.agentmail.to/api-reference/inboxes/webhooks/delete
...
HttpResponse<String> response = Unirest.delete("https://api.agentmail.to/v0/inboxes/inbox_id/webhooks/webhook_id")
...
$response = $client->request('DELETE', 'https://api.agentmail.to/v0/inboxes/inbox_id/webhooks/webhook_id', [
  'headers' => [
