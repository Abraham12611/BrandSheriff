...
PATCH https://api.agentmail.to/v0/inboxes/{inbox_id}/webhooks/{webhook_id}
...
Reference: https://docs.agentmail.to/api-reference/inboxes/webhooks/update
...
HttpResponse<String> response = Unirest.patch("https://api.agentmail.to/v0/inboxes/inbox_id/webhooks/webhook_id")
...
$response = $client->request('PATCH', 'https://api.agentmail.to/v0/inboxes/inbox_id/webhooks/webhook_id', [
  'body' => '{}',
  'headers' => [
