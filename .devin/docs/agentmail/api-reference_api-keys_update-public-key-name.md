...
PATCH https://api.agentmail.to/v0/api-keys/public-keys/{api_key_id}
Content-Type: application/json

Rename the credential. All security-relevant fields are immutable.
Requires `api_key_update`.

Reference: https://docs.agentmail.to/api-reference/api-keys/update-public-key-name
...
- `api_key_id` (UUID, required) — Public-key credential ID returned by registration.
...
func main() {
	...
	url := "https://api.agentmail.to/v0/api-keys/public-keys/d5e9c84f-c2b2-4bf4-b4b0-7ffd7a9ffc32"
...
url = URI("https://api.agentmail.to/v0/api-keys/public-keys/d5e9c84f-c2b2-4bf4-b4b0-7ffd7a9ffc32")
...
HttpResponse<String> response = Unirest.patch("https://api.agentmail.to/v0/api-keys/public-keys/d5e9c84f-c2b2-4bf4-b4b0-7ffd7a9ffc32")
...
$response = $client->request('PATCH', 'https://api.agentmail.to/v0/api-keys/public-keys/d5e9c84f-c2b2-4bf4-b4b0-7ffd7a9ffc32', [
  'body' => '{
  "name": "x"
}',
  'headers' => [
...
var client = new RestClient("https://api.agentmail.to/v0/api-keys/public-keys/d5e9c84f-c2b2-4bf4-b4b0-7ffd7a9ffc32");
...
let parameters = ["name": "x"] as [String : Any]

let postData = JSONSerialization.data(withJSONObject: parameters, options: [])

let request = NSMutableURLRequest(url: NSURL(string: "https://api.agentmail.to/v0/api-keys/public-keys/d5e9c84f-c2b2-4bf4-b4b0-7ffd7a9ffc32")! as URL,
