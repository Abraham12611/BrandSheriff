...
- `labels` (list of string, optional) — Labels of draft.
...
- `attachments` (list of object, optional) — Attachments to include in draft.
...
- `reply_all` (boolean, optional) — Reply to all recipients of the original message.
