...
GET https://api.agentmail.to/v0/inboxes/{inbox_id}/metrics/events
...
Reference: https://docs.agentmail.to/api-reference/inboxes/metrics/query-events
...
func main() {
	...
	url := "https://api.agentmail.to/v0/inboxes/inbox_id/metrics/events"
...
url = URI("https://api.agentmail.to/v0/inboxes/inbox_id/metrics/events")
...
HttpResponse<String> response = Unirest.get("https://api.agentmail.to/v0/inboxes/inbox_id/metrics/events")
...
$response = $client->request('GET', 'https://api.agentmail.to/v0/inboxes/inbox_id/metrics/events', [
  'headers' => [
...
var client = new RestClient("https://api.agentmail.to/v0/inboxes/inbox_id/metrics/events");
...
let request = NSMutableURLRequest(url: NSURL(string: "https://api.agentmail.to/v0/inboxes/inbox_id/metrics/events")! as URL,
