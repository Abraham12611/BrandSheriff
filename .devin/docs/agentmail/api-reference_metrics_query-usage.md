...
GET https://api.agentmail.to/v0/metrics/usage
...
Reference: https://docs.agentmail.to/api-reference/metrics/query-usage
...
func main() {
	...
	url := "https://api.agentmail.to/v0/metrics/usage"
...
url = URI("https://api.agentmail.to/v0/metrics/usage")
...
HttpResponse<String> response = Unirest.get("https://api.agentmail.to/v0/metrics/usage")
...
$response = $client->request('GET', 'https://api.agentmail.to/v0/metrics/usage', [
  'headers' => [
...
var client = new RestClient("https://api.agentmail.to/v0/metrics/usage");
...
let request = NSMutableURLRequest(url: NSURL(string: "https://api.agentmail.to/v0/metrics/usage")! as URL,
