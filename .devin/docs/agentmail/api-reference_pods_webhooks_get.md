...
GET https://api.agentmail.to/v0/pods/{pod_id}/webhooks/{webhook_id}
...
Reference: https://docs.agentmail.to/api-reference/pods/webhooks/get
...
HttpResponse<String> response = Unirest.get("https://api.agentmail.to/v0/pods/pod_id/webhooks/webhook_id")
...
$response = $client->request('GET', 'https://api.agentmail.to/v0/pods/pod_id/webhooks/webhook_id', [
  'headers' => [
