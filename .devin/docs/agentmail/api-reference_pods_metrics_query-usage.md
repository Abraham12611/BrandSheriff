...
GET https://api.agentmail.to/v0/pods/{pod_id}/metrics/usage
...
Reference: https://docs.agentmail.to/api-reference/pods/metrics/query-usage
...
func main() {
	...
	url := "https://api.agentmail.to/v0/pods/pod_id/metrics/usage"
...
url = URI("https://api.agentmail.to/v0/pods/pod_id/metrics/usage")
...
HttpResponse<String> response = Unirest.get("https://api.agentmail.to/v0/pods/pod_id/metrics/usage")
...
$response = $client->request('GET', 'https://api.agentmail.to/v0/pods/pod_id/metrics/usage', [
  'headers' => [
...
var client = new RestClient("https://api.agentmail.to/v0/pods/pod_id/metrics/usage");
...
let request = NSMutableURLRequest(url: NSURL(string: "https://api.agentmail.to/v0/pods/pod_id/metrics/usage")! as URL,
