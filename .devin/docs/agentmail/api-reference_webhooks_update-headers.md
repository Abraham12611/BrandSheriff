...
PATCH https://api.agentmail.to/v0/webhooks/{webhook_id}/headers
...
Reference: https://docs.agentmail.to/api-reference/webhooks/update-headers
...
func main() {
	...
	url := "https://api.agentmail.to/v0/webhooks/webhook_id/headers"
...
url = URI("https://api.agentmail.to/v0/webhooks/webhook_id/headers")
...
HttpResponse<String> response = Unirest.patch("https://api.agentmail.to/v0/webhooks/webhook_id/headers")
...
$response = $client->request('PATCH', 'https://api.agentmail.to/v0/webhooks/webhook_id/headers', [
  'body' => '{}',
  'headers' => [
...
var client = new RestClient("https://api.agentmail.to/v0/webhooks/webhook_id/headers");
...
let request = NSMutableURLRequest(url: NSURL(string: "https://api.agentmail.to/v0/webhooks/webhook_id/headers")! as URL,
