...
<CardGroup cols={2}>
  <Card title="Use the dashboard or CLI" icon="user" href="https://www.firecrawl.dev/agent-onboarding/SKILL.md">
  ...
  <Card title="Register with WorkOS ID-JAG" icon="robot" href="/ai-onboarding/agent-auth">
