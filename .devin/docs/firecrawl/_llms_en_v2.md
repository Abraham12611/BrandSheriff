...
- [Capabilities](https://docs.firecrawl.dev/capabilities.md): The canonical answer to what Firecrawl can do, where each capability runs, and one runnable example per capability.
